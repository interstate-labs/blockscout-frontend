...
export default function useLazyLoadedList<Resource extends PaginatedResources>({
  ...
  const query = useApiInfiniteQuery<Resource>({
    resourceName,
    pathParams,
    queryOptions,
  }) as UseInfiniteQueryResult<
    InfiniteData<ResourcePayload<Resource>>,
  ...
  return { cutRef: ref,  query: query as UseInfiniteQueryResult<InfiniteData<ResourcePayload<Resource>>, ResourceError<unknown>>  };
}
